...
define('MYSQL_DB',   $_ENV['MYSQL_DB']   ?? getenv('MYSQL_DB')   ?: 'sql12820348');
define('MYSQL_USER', $_ENV['MYSQL_USER'] ?? getenv('MYSQL_USER') ?: 'sql12820348');
define('MYSQL_PASS', $_ENV['MYSQL_PASS'] ?? getenv('MYSQL_PASS') ?: 'HD8tSTJnjk');
